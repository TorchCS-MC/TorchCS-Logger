...
void CustomFormatter::format(const spdlog::details::log_msg& msg, spdlog::memory_buf_t& dest) {
    ...
    switch (msg.level) {
        case spdlog::level::info: log_level = "INFO"; break;
        case spdlog::level::warn: log_level = "WARN"; break;
        case spdlog::level::err: log_level = "ERROR"; break;
        case spdlog::level::debug: log_level = "DEBUG"; break;
        case spdlog::level::critical: log_level = "CRITICAL"; break;
        case spdlog::level::trace: log_level = "TRACE"; break;
